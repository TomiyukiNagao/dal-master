...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Dalcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Dalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Dalcoin transaction") + "\n" +
              "  Dalcoin-tx [options] -create [commands]   " + _("Create hex-encoded Dalcoin transaction") + "\n" +
              "\n";

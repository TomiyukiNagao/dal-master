...
const char * const BITCOIN_CONF_FILENAME = "Dalcoin.conf";
const char * const BITCOIN_PID_FILENAME = "Dalcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dalcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dalcoin";
#else
    // Unix
    return pathRet / ".Dalcoin";
#endif
#endif
}

...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.Dalcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.Dalcointools.com");
        vSeeds.emplace_back("dnsseed.Dalcoinpool.org");
        ...
        fDefauDALonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Dalcointools.com");
        vSeeds.emplace_back("seed-b.Dalcoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        fDefauDALonsistencyChecks = true;
        fRequireStandard = false;

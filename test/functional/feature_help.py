...
"""Verify that starting Dalcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Dalcoin with -h for help text")
        ...
        self.log.info("Start Dalcoin with -version for version information")

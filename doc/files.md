...
* Dalcoin.conf: contains configuration settings for Dalcoind or Dalcoin-qt
* Dalcoind.pid: stores the process id of Dalcoind while running
...
* debug.log: contains debug information and general logging generated by Dalcoind or Dalcoin-qt
